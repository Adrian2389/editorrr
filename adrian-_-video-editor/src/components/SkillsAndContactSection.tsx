            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              {SKILLS.map((skill) => (
                <div
                  ...
                  className="group flex flex-col items-center text-center p-4 rounded-xl bg-[#0d0d12]/60 border border-zinc-800/80 hover:border-zinc-700 transition-all duration-300 hover:bg-[#121219]"
                >
          ...
          <div id="contact" className="lg:col-span-6">
            ...
            <div className="flex flex-col space-y-5 text-sm sm:text-base">
              ...
              <div
                ...
                className="flex items-center justify-between p-3 rounded-lg border border-transparent hover:border-zinc-800 hover:bg-zinc-900/40 transition-colors group cursor-pointer"
                onClick={() => copyToClipboard(CONTACT.email, 'email')}
                title="Click to copy email address"
              >
                <div className="flex items-center gap-4 text-zinc-300">
                  <div className="w-9 h-9 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 group-hover:text-white group-hover:border-zinc-700 transition-colors">
                    <Mail size={18} />
                  </div>
                  <a
                ...
                <button
                  type="button"
                  className="text-zinc-500 hover:text-zinc-300 transition-colors text-xs flex items-center gap-1.5 px-2 py-1 rounded"
                >
                  {copiedField === 'email' ? (
              ...
              >
                <div className="flex items-center gap-4 text-zinc-300">
                  ...
                  <span className="hover:text-white transition-colors">{CONTACT.discord}</span>
                </div>
                <button
                  type="button"
                  className="text-zinc-500 hover:text-zinc-300 transition-colors text-xs flex items-center gap-1.5 px-2 py-1 rounded"
              ...
              <a
                ...
                className="flex items-center justify-between p-3 rounded-lg border border-transparent hover:border-zinc-800 hover:bg-zinc-900/40 transition-colors group"
              >
                <div className="flex items-center gap-4 text-zinc-300">
                  <div className="w-9 h-9 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 group-hover:text-white group-hover:border-zinc-700 transition-colors">
                    {/* X logo SVG */}
                  ...
                  <span className="group-hover:text-white transition-colors">{CONTACT.twitter}</span>
                </div>
