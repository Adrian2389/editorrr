      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start pt-4 sm:pt-8">
            ...
            <p
              id="hero-description"
              className="text-zinc-400 text-sm sm:text-base leading-relaxed max-w-lg mb-8 font-normal"
            >
              Specializing in YouTube longform storytelling, documentaries and high-retention content. Focusing on pacing, emotion and visual impact.
            </p>
